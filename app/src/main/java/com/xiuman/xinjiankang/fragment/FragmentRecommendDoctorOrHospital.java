 ...
 */
public class FragmentRecommendDoctorOrHospital extends Fragment {

    public static final String LOADTYPE = "type";
    public static final int typeDoctor = 1;
    public static final int typeHospital = 2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (thisView == null) {
            ...
            loadType = getArguments().getInt(LOADTYPE);
            //初始化
            {
                int myPagerHeight = (int) (SizeUtil.getScreenHeight() * (234 / 1334f));
...
//                recyclerView.setLayoutParams(params2);
    ...
    class GalleryHospitorrAdapter extends RecyclerView.Adapter<GalleryHospitorrAdapter.ViewHolder> {
        ...
        public GalleryHospitorrAdapter(Context context, Wrapper<RecommendHosipatal> doctorlist) {
            mInflater = LayoutInflater.from(context);
            this.dataList = doctorlist;
            options = new ImageOptions.Builder().setSize(52, 52).setRadius(8)
                    .setImageScaleType(ImageView.ScaleType.CENTER_CROP).build();
        }
